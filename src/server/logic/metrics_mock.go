...
//
//	mockgen --build_flags=--mod=mod -destination metrics_mock.go -package logic rss_parrot/logic IMetrics
//
...
func (m *MockIMetrics) StartApubRequestIn(arg0 string) IRequestObserver {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StartApubRequestIn", arg0)
	ret0, _ := ret[0].(IRequestObserver)
	return ret0
}
...
func (m *MockIMetrics) StartApubRequestOut(arg0 string) IRequestObserver {
	m.ctrl.T.Helper()
...
func (m *MockIMetrics) StartWebRequestIn(arg0 string) IRequestObserver {
	m.ctrl.T.Helper()
